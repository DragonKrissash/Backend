...
app.post("/jokes",(req,res)=>{
  ...
  const newjk=req.body;
  let newjoke={id: jokes.length+1,jokeText:newjk.jokeText,jokeType:newjk.jokeType};
  console.log(newjoke);
  jokes.push(newjoke);
...
app.put("/jokes/:id",(req,res)=>{
  ...
  jokes[id-1]={id:id,jokeText:jokedata.text,jokeType:jokedata.type};
  res.send(jokes[id-1]);
})
...
app.patch("/jokes/:id",(req,res)=>{
  ...
  jokes[ind]={id:id,
    jokeText:jokedata.text||jokes[ind].jokeText,
    jokeType:jokedata.type||jokes[ind].jokeType};
  res.send(jokes[ind]);
})
...
app.delete("/jokes/:id",(req,res)=>{
  const id=parseInt(req.params.id);
  const ind=jokes.find((joke)=>joke.id===id);
  jokes.splice(ind,1);
  console.log(jokes);
  res.send("Done");
})
